            ...
            <FlatList
                ...
                ListHeaderComponent={
                    <RewardsHeader
                        ...
                        likeCount={likeCount}
                        visitedCafesCount={visitedCafesCount}
                    />
                }
                renderItem={({ item }) => (
                    <BadgeListItem
...
type RewardsHeaderProps = {
    progress: ReturnType<typeof useRewardsViewModel>["progress"];
...
function RewardsHeader(props: RewardsHeaderProps) {
    const {
        progress,
        confirmedTickets,
        badgesCount,
        ...
        <View style={styles.header}>
            <View style={styles.headerTopRow}>
                ...
                <View style={styles.unlockedCard}>
                    ...
                    <Text style={styles.unlockedCaption}>sur {badgesCount}</Text>
            ...
            <View style={styles.secondaryRow}>
                <View style={styles.smallCard}>
                    <Text style={styles.smallTitle}>Activité sociale</Text>
                    <View style={styles.smallRow}>
                        <Text style={styles.smallMetric}>💬 {commentCount} commentaires</Text>
                        <Text style={styles.smallMetric}>❤️ {likeCount} likes</Text>
                    </View>
                </View>
                <View style={styles.smallCard}>
                    <Text style={styles.smallTitle}>Exploration IRL</Text>
                    <Text style={styles.smallMetric}>{visitedCafesCount} cafés croisés</Text>
                    <Text style={styles.smallHint}>Détectés grâce à ta position.</Text>
                </View>
            </View>
...
function BadgeListItem(props: BadgeListItemProps) {
    const { badge: item, progress, confirmedTickets, commentCount, likeCount, visitedCafesCount } = props;
        ...
        <View style={styles.badgeCard}>
            ...
            <View style={styles.requirementsRow}>
                <Text style={styles.requirementTiny}>
                    🔍 Explo. {Math.min(progress.exploration, item.requirements.exploration)} /
                    {item.requirements.exploration}
                </Text>
                <Text style={styles.requirementTiny}>
                    ☕️ Goût {Math.min(progress.gout, item.requirements.gout)} / {item.requirements.gout}
                </Text>
                <Text style={styles.requirementTiny}>
                    💬 Social {Math.min(progress.social, item.requirements.social)} / {item.requirements.social}
                </Text>
            </View>

            <View style={styles.sourcesBlock}>
                <Text style={styles.sourcesTitle}>Ce badge progresse avec :</Text>
                <Text style={styles.sourcesLine}>
                    🔍 {visitedCafesCount} cafés croisés · {progress.exploration} points d’exploration
                </Text>
                <Text style={styles.sourcesLine}>
                    ☕️ {confirmedTickets} tickets validés ({progress.gout} points de goût)
                </Text>
                <Text style={styles.sourcesLine}>
                    💬 {commentCount} commentaires · ❤️ {likeCount} likes ({progress.social} points sociaux)
                </Text>
            </View>
