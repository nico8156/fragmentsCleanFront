...
Le runtime utilise le gateway HTTP réel. Les articles valides sont conservés
dans le cache durable et `projection.updated/articles` déclenche un nouveau GET
sans transporter de contenu métier. Voir `docs/architecture/article-reading-flow.md`.
