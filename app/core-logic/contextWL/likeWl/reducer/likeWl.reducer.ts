import { likeSyncAcked, likeSyncCleared, likeSyncFailed, likeSyncPending } from "@/app/core-logic/contextWL/likeWl/typeAction/likeSync.action";
import {
...
export const likeWlReducer = createReducer(
	...
	(builder) => {
		...
		builder.addCase(likeSyncAcked, (state, { payload }) => {
			...
			// ✅ éteint "optimistic" si tu veux que le UI soit clean
			v.optimistic = false;
		});
